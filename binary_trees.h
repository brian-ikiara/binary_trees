 ...
 *
 * Description: Defines a basic Binary Tree node.
 */
typedef struct binary_tree_s binary_tree_t;

/**
 * bst_t - Typedef for struct binary_tree_s
 *
 * Description: Defines a basic Binary Search Tree node.
 */
typedef struct binary_tree_s bst_t;

/**
 * avl_t - Typedef for struct binary_tree_s
 *
 * Description: Defines a basic AVL(Adelson-Velsky and Landis) Tree node.
 */
typedef struct binary_tree_s avl_t;

/**
 * heap_t - Typedef for struct binary_tree_s
 *
 * Description: Defines a Heap node.
 */
typedef struct binary_tree_s heap_t;

/* Prototype for the printing function */
void binary_tree_print(const binary_tree_t *);

/* Prototypes for the Binary Trees */
